...
CREATE UniswapV2Exchange.constructor(_uniswap=0xf164fC0Ec4E93095b804a4795bBe1e041497b92a) => (0x74652f570B1A95235a9A054994319eeb827c5E17)
  web3-candies deployed UniswapV2Exchange 0x74652f570B1A95235a9A054994319eeb827c5E17 deployer 0x040a92b0eb92c573a1594d032b139524bc6618f4 +41ms
...
CALL TWAP.ask(exchange=0x0000000000000000000000000000000000000000, srcToken=[USDC], dstToken=[WETH], srcAmount=100, srcBidAmount=10, dstMinAmount=1, deadline=4294967294, delay=60)
      ✓ insufficient maker balance (66ms)
    verify bid
...
CALL TWAP.bid(id=1, exchange=[UniswapV2Exchange], dstFee=10000000000000000, data=)
  ...
  web3-candies deploying TWAP +70ms
  ...
  web3-candies impersonating 0x55fe002aeff02f77364de339a1292923a15844b8 +0ms
  web3-candies deploying MockExchange +16ms
...
CALL TWAP.ask(exchange=[MockExchange], srcToken=[USDC], dstToken=[WETH], srcAmount=2000000000, srcBidAmount=2000000000, dstMinAmount=1000000000000000000, deadline=1654431410, delay=60)
  ...
  web3-candies was: block 14908989 timestamp 2022-06-05T12:00:12.000Z now: block 14908990 timestamp 2022-06-05T12:00:22.000Z +2ms
      ✓ invalid exchange (171ms)
  web3-candies resetNetworkFork to 14908980 +40ms
  web3-candies now block 14908980 +1s
  web3-candies deploying UniswapV2Exchange +3ms
  web3-candies deployed UniswapV2Exchange 0x74652f570B1A95235a9A054994319eeb827c5E17 deployer 0x040a92b0eb92c573a1594d032b139524bc6618f4 +17ms
  web3-candies deploying TWAP +39ms
  web3-candies deployed TWAP 0xCE5c12eEA2772EFc7A665E7aA26c059D6fDC5de5 deployer 0x040a92b0eb92c573a1594d032b139524bc6618f4 +21ms
...
CALL TWAP.bid(id=1, exchange=[UniswapV2Exchange], dstFee=10000000000000000, data=)
   TWAP.OrderBid(taker=[taker], id=1, exchange=[UniswapV2Exchange], bid=[1654430413, [taker], [UniswapV2Exchange], 1107925290738887788, 10000000000000000, ])
      ✓ low bid (277ms)
  web3-candies resetNetworkFork to 14908980 +309ms
...
CALL TWAP.ask(exchange=0x0000000000000000000000000000000000000000, srcToken=[USDC], dstToken=[WETH], srcAmount=2000000000, srcBidAmount=1000000000, dstMinAmount=500000000000000000, deadline=1654431406, delay=60)
  ...
  web3-candies mining 1 block and advancing time by 30 seconds +94ms
...
CALL TWAP.bid(id=0, exchange=[UniswapV2Exchange], dstFee=10000000000000000, data=)
  ...
  web3-candies deployed UniswapV2Exchange 0x74652f570B1A95235a9A054994319eeb827c5E17 deployer 0x040a92b0eb92c573a1594d032b139524bc6618f4 +27ms
...
CALL TWAP.ask(exchange=0x0000000000000000000000000000000000000000, srcToken=[USDC], dstToken=[WETH], srcAmount=2000000000, srcBidAmount=1000000000, dstMinAmount=500000000000000000, deadline=1654431406, delay=600)
  ...
  web3-candies mining 1 block and advancing time by 30 seconds +107ms
...
CALL TWAP.fill(id=0)
   ...
   TWAP.OrderFilled(taker=[taker], id=0, exchange=[UniswapV2Exchange], srcToken=[USDC], dstToken=[WETH], srcAmountIn=1000000000, dstAmountOut=548969740337624487, dstFee=10000000000000000, filledTime=1654430440, srcFilledAmount=1000000000)
CALL TWAP.bid(id=0, exchange=[UniswapV2Exchange], dstFee=10000000000000000, data=)
  web3-candies mining 1 block and advancing time by 60 seconds +175ms
...
CALL TWAP.bid(id=0, exchange=[UniswapV2Exchange], dstFee=10000000000000000, data=)
   TWAP.OrderBid(taker=[taker], id=0, exchange=[UniswapV2Exchange], bid=[1654431103, [taker], [UniswapV2Exchange], 548955529052854682, 10000000000000000, ])
      ✓ recently filled custom delay (335ms)
...
CALL TWAP.bid(id=0, exchange=[MockExchange], dstFee=10000000000000000, data=)
      ✓ insufficient amount out when last partial fill (260ms)
...
CALL USDC.approve(spender=[TWAP], amount=0)
   USDC.Approval(owner=[user], spender=[TWAP], value=0)
      ✓ insufficient user allowance (74ms)
...
CALL USDC.transfer(to=[taker], amount=1000000000000)
   USDC.Transfer(from=[user], to=[taker], value=1000000000000)
      ✓ insufficient user balance (86ms)
    perform fill
  ...
  web3-candies now block 14908980 +784ms
  web3-candies deploying UniswapV2Exchange +3ms
  web3-candies deployed UniswapV2Exchange 0x74652f570B1A95235a9A054994319eeb827c5E17 deployer 0x040a92b0eb92c573a1594d032b139524bc6618f4 +16ms
  web3-candies deploying TWAP +22ms
  web3-candies deployed TWAP 0xCE5c12eEA2772EFc7A665E7aA26c059D6fDC5de5 deployer 0x040a92b0eb92c573a1594d032b139524bc6618f4 +8ms
  web3-candies impersonating 0x55fe002aeff02f77364de339a1292923a15844b8 +0ms
CALL TWAP.fill(id=0)
      ✓ invalid taker when no existing bid (44ms)
  ...
  web3-candies impersonating 0x55fe002aeff02f77364de339a1292923a15844b8 +0ms
CALL TWAP.fill(id=0)
      ✓ invalid taker when not the winning taker (86ms)
...
CALL TWAP.fill(id=0)
  ...
  web3-candies now block 14908980 +820ms
  web3-candies deploying UniswapV2Exchange +2ms
  web3-candies deployed UniswapV2Exchange 0x74652f570B1A95235a9A054994319eeb827c5E17 deployer 0x040a92b0eb92c573a1594d032b139524bc6618f4 +12ms
  ...
  web3-candies impersonating 0x55fe002aeff02f77364de339a1292923a15844b8 +0ms
  web3-candies deploying MockExchange +71ms
CREATE MockExchange.constructor() => ([MockExchange])
  web3-candies deployed MockExchange 0xA1041132B507466bE2b840b0BdFc78CA333b5861 deployer 0x040a92b0eb92c573a1594d032b139524bc6618f4 +14ms
  web3-candies impersonating 0xBA12222222228d8Ba445958a75a0704d566BF2C8 +1ms
CALL WETH.transfer(to=[MockExchange], amount=10000000000000000000000)
...
CALL TWAP.fill(id=0)
      ✓ insufficient out with excess fee (175ms)
...
CALL TWAP.bid(id=0, exchange=[MockExchange], dstFee=1000000000000000000, data=)
  ...
  web3-candies was: block 14908989 timestamp 2022-06-05T12:00:12.000Z now: block 14908990 timestamp 2022-06-05T12:00:22.000Z +1ms
      ✓ fee subtracted from dstAmountOut underflow protection (168ms)
...
CALL TWAP.ask(exchange=0x0000000000000000000000000000000000000000, srcToken=[USDC], dstToken=[WETH], srcAmount=3000000, srcBidAmount=2000000, dstMinAmount=1000000000000000000, deadline=1654430506, delay=60)
  ...
  web3-candies was: block 14908986 timestamp 2022-06-05T12:00:09.000Z now: block 14908987 timestamp 2022-06-05T12:00:39.000Z +1ms
    ✓ fill sets Fill fields and clears the Bid, emits event (181ms)
...
CALL TWAP.bid(id=0, exchange=[UniswapV2Exchange], dstFee=10000000000000000, data=)
    ✓ cancel order, emits event (78ms)
  web3-candies resetNetworkFork to 14908980 +89ms
  web3-candies now block 14908980 +848ms
  web3-candies deploying UniswapV2Exchange +3ms
  web3-candies deployed UniswapV2Exchange 0x74652f570B1A95235a9A054994319eeb827c5E17 deployer 0x040a92b0eb92c573a1594d032b139524bc6618f4 +15ms
  ...
  web3-candies impersonating 0x55fe002aeff02f77364de339a1292923a15844b8 +1ms
  web3-candies mining 1 block and advancing time by 10 seconds +113ms
  web3-candies was: block 14908986 timestamp 2022-06-05T12:00:09.000Z now: block 14908987 timestamp 2022-06-05T12:00:19.000Z +1ms
  web3-candies mining 1 block and advancing time by 60 seconds +113ms
  web3-candies was: block 14908988 timestamp 2022-06-05T12:00:20.000Z now: block 14908989 timestamp 2022-06-05T12:01:20.000Z +1ms
CALL TWAP.bid(id=0, exchange=[UniswapV2Exchange], dstFee=10000000000000000, data=)
...
CALL TWAP.bid(id=0, exchange=[UniswapV2Exchange], dstFee=10000000000000000, data=)
    ✓ order fully filled, emits event (444ms)
    History
...
CALL TWAP.cancel(id=1)
  ...
  web3-candies impersonating 0x55fe002aeff02f77364de339a1292923a15844b8 +121ms
...
CALL TWAP.bid(id=0, exchange=[UniswapV2Exchange], dstFee=10000000000000000, data=)
  ...
  web3-candies mining 1 block and advancing time by 10 seconds +112ms
  web3-candies was: block 14908986 timestamp 2022-06-05T12:00:09.000Z now: block 14908987 timestamp 2022-06-05T12:00:19.000Z +1ms
CALL TWAP.fill(id=0)
...
CALL TWAP.fill(id=0)
   ...
   TWAP.OrderFilled(taker=[taker], id=0, exchange=[UniswapV2Exchange], srcToken=[USDC], dstToken=[WETH], srcAmountIn=2500000000, dstAmountOut=1387308929430581229, dstFee=10000000000000000, filledTime=1654430493, srcFilledAmount=5000000000)
...
CALL TWAP.ask(exchange=0x0000000000000000000000000000000000000000, srcToken=[USDC], dstToken=[WETH], srcAmount=10000000000, srcBidAmount=4000000000, dstMinAmount=2000000000000000000, deadline=1654431406, delay=60)
  ...
  web3-candies mining 1 block and advancing time by 10 seconds +97ms
...
CALL TWAP.bid(id=0, exchange=[UniswapV2Exchange], dstFee=10000000000000000, data=)
  ...
  web3-candies was: block 14908994 timestamp 2022-06-05T12:02:33.000Z now: block 14908995 timestamp 2022-06-05T12:02:44.000Z +1ms
CALL TWAP.fill(id=0)
   USDC.Transfer(from=[user], to=[TWAP], value=2000000000)
   USDC.Approval(owner=[TWAP], spender=[UniswapV2Exchange], value=2000000000)
   USDC.Transfer(from=[TWAP], to=[UniswapV2Exchange], value=2000000000)
   ...
   TWAP.OrderCompleted(taker=[taker], id=0)
    ✓ last chunk may be partial amount (578ms)
...
CALL TWAP.fill(id=0)
   ...
   TWAP.OrderFilled(taker=[taker], id=0, exchange=[MockExchange], srcToken=[USDC], dstToken=[WETH], srcAmountIn=1000000000, dstAmountOut=590000000000000000, dstFee=10000000000000000, filledTime=1654430425, srcFilledAmount=1000000000)
    ✓ outbid current bid within pending period (253ms)
  web3-candies resetNetworkFork to 14908980 +97ms
  web3-candies now block 14908980 +1s
  web3-candies deploying UniswapV2Exchange +3ms
  web3-candies deployed UniswapV2Exchange 0x74652f570B1A95235a9A054994319eeb827c5E17 deployer 0x040a92b0eb92c573a1594d032b139524bc6618f4 +16ms
  ...
  web3-candies impersonating 0x55fe002aeff02f77364de339a1292923a15844b8 +1ms
  web3-candies mining 1 block and advancing time by 1 seconds +103ms
  web3-candies was: block 14908986 timestamp 2022-06-05T12:00:09.000Z now: block 14908987 timestamp 2022-06-05T12:00:10.000Z +1ms
CALL TWAP.bid(id=0, exchange=[UniswapV2Exchange], dstFee=1000000000000000, data=)
   TWAP.OrderBid(taker=0x56C037B948a812C5A0Ad9cCc122F5015EF928F27, id=0, exchange=[UniswapV2Exchange], bid=[1654430411, 0x56C037B948a812C5A0Ad9cCc122F5015EF928F27, [UniswapV2Exchange], 557969740337624487, 1000000000000000, ])
    ✓ outbid current bid within pending period same path and amount but lower fee (149ms)
...
CALL TWAP.bid(id=0, exchange=[UniswapV2Exchange], dstFee=10000000000000000, data=)
  web3-candies mining 1 block and advancing time by 1 seconds +34ms
...
CALL TWAP.bid(id=0, exchange=[UniswapV2Exchange], dstFee=10000000000000000, data=)
   TWAP.OrderBid(taker=[taker], id=0, exchange=[UniswapV2Exchange], bid=[1654430470, [taker], [UniswapV2Exchange], 548969740337624487, 10000000000000000, ])
    ✓ clears stale unfilled bid after max bidding window (170ms)
...
CALL TWAP.bid(id=0, exchange=[UniswapV2Exchange], dstFee=10000000000000000, data=)
  ...
  web3-candies mining 1 block and advancing time by 10 seconds +331ms
  web3-candies was: block 14908989 timestamp 2022-06-05T12:00:12.000Z now: block 14908990 timestamp 2022-06-05T12:00:23.000Z +1ms
CALL TWAP.fill(id=0)
   USDC.Transfer(from=[user], to=[TWAP], value=1000000000)
   USDC.Approval(owner=[TWAP], spender=[UniswapV2Exchange], value=1000000000)
   USDC.Transfer(from=[TWAP], to=[UniswapV2Exchange], value=1000000000)
   ...
   WETH.Transfer(from=[TWAP], to=[taker], value=10000000000000000)
   WETH.Transfer(from=[TWAP], to=[user], value=548969740337624487)
   TWAP.OrderFilled(taker=[taker], id=0, exchange=[UniswapV2Exchange], srcToken=[USDC], dstToken=[WETH], srcAmountIn=1000000000, dstAmountOut=548969740337624487, dstFee=10000000000000000, filledTime=1654430424, srcFilledAmount=1000000000)
    ✓ supports market orders, english auction incentivizes best competitive price (487ms)
    prune stale invalid order
  web3-candies resetNetworkFork to 14908980 +165ms
  web3-candies now block 14908980 +1s
  web3-candies deploying UniswapV2Exchange +4ms
  web3-candies deployed UniswapV2Exchange 0x74652f570B1A95235a9A054994319eeb827c5E17 deployer 0x040a92b0eb92c573a1594d032b139524bc6618f4 +15ms
  web3-candies deploying TWAP +22ms
...
CALL TWAP.prune(id=0)
   TWAP.OrderCanceled(sender=[deployer], id=0)
      ✓ when no approval (115ms)
  web3-candies resetNetworkFork to 14908980 +128ms
  web3-candies now block 14908980 +820ms
  web3-candies deploying UniswapV2Exchange +3ms
  web3-candies deployed UniswapV2Exchange 0x74652f570B1A95235a9A054994319eeb827c5E17 deployer 0x040a92b0eb92c573a1594d032b139524bc6618f4 +16ms
  web3-candies deploying TWAP +23ms
...
CALL TWAP.prune(id=0)
   TWAP.OrderCanceled(sender=[deployer], id=0)
      ✓ when no balance (123ms)

·-----------------------------------|---------------------------|-------------|-----------------------------·
|       Solc version: 0.8.10        ·  Optimizer enabled: true  ·  Runs: 200  ·  Block limit: 10000000 gas  │
····································|···························|·············|······························
|  Methods                          ·               9 gwei/gas                ·       1651.51 usd/eth       │
·················|··················|·············|·············|·············|···············|··············
|  Contract      ·  Method          ·  Min        ·  Max        ·  Avg        ·  # calls      ·  usd (avg)  │
·················|··················|·············|·············|·············|···············|··············
|  ERC20         ·  approve         ·      38027  ·      59975  ·      57222  ·           43  ·       0.85  │
·················|··················|·············|·············|·············|···············|··············
|  ERC20         ·  transfer        ·      51618  ·      65625  ·      63574  ·           48  ·       0.94  │
·················|··················|·············|·············|·············|···············|··············
|  MockExchange  ·  setMockAmounts  ·      32211  ·      69211  ·      56878  ·            9  ·       0.85  │
·················|··················|·············|·············|·············|···············|··············
|  TWAP          ·  ask             ·     236700  ·     308100  ·     281899  ·           39  ·       4.19  │
·················|··················|·············|·············|·············|···············|··············
|  TWAP          ·  bid             ·     113915  ·     293111  ·     263552  ·           36  ·       3.92  │
·················|··················|·············|·············|·············|···············|··············
|  TWAP          ·  cancel          ·      73143  ·      73205  ·      73174  ·            2  ·       1.09  │
·················|··················|·············|·············|·············|···············|··············
|  TWAP          ·  fill            ·     271652  ·     349005  ·     323878  ·           16  ·       4.81  │
·················|··················|·············|·············|·············|···············|··············
|  TWAP          ·  prune           ·      74900  ·      90347  ·      83881  ·            3  ·       1.25  │
·················|··················|·············|·············|·············|···············|··············
|  Deployments                      ·                                         ·  % of limit   ·             │
····································|·············|·············|·············|···············|··············
|  MockExchange                     ·          -  ·          -  ·     543346  ·        5.4 %  ·       8.08  │
····································|·············|·············|·············|···············|··············
|  TWAP                             ·          -  ·          -  ·    2490580  ·       24.9 %  ·      37.02  │
····································|·············|·············|·············|···············|··············
|  UniswapV2Exchange                ·          -  ·          -  ·     646460  ·        6.5 %  ·       9.61  │
·-----------------------------------|-------------|-------------|-------------|---------------|-------------·
...
CREATE TWAP.constructor() => (0xCE5c12eEA2772EFc7A665E7aA26c059D6fDC5de5)
  web3-candies deployed TWAP 0xCE5c12eEA2772EFc7A665E7aA26c059D6fDC5de5 deployer 0x040a92b0eb92c573a1594d032b139524bc6618f4 +293ms
...
CALL USDC.transfer(to=[user], amount=1000000000000)
  ...
  web3-candies now block 29194866 +2s
  web3-candies deploying UniswapV2Exchange +4ms
  web3-candies deployed UniswapV2Exchange 0x74652f570B1A95235a9A054994319eeb827c5E17 deployer 0x040a92b0eb92c573a1594d032b139524bc6618f4 +497ms
  web3-candies deploying TWAP +2s
...
CALL USDC.approve(spender=[TWAP], amount=5)
   USDC.Approval(owner=[user], spender=[TWAP], value=5)
CALL TWAP.ask(exchange=0x0000000000000000000000000000000000000000, srcToken=[USDC], dstToken=[WETH], srcAmount=100, srcBidAmount=10, dstMinAmount=1, deadline=4294967294, delay=60)
      ✓ insufficient maker allowance (465ms)
...
CALL USDC.transfer(to=[taker], amount=1000000000000)
   USDC.Transfer(from=[user], to=[taker], value=1000000000000)
CALL TWAP.ask(exchange=0x0000000000000000000000000000000000000000, srcToken=[USDC], dstToken=[WETH], srcAmount=100, srcBidAmount=10, dstMinAmount=1, deadline=4294967294, delay=60)
      ✓ insufficient maker balance (912ms)
    verify bid
  web3-candies resetNetworkFork to 29194866 +2s
  web3-candies now block 29194866 +2s
  web3-candies deploying UniswapV2Exchange +2ms
...
CALL TWAP.bid(id=1, exchange=[UniswapV2Exchange], dstFee=10000000000000000, data=)
   TWAP.OrderBid(taker=[taker], id=1, exchange=[UniswapV2Exchange], bid=[1654430421, [taker], [UniswapV2Exchange], 1108103577899766128, 10000000000000000, ])
      ✓ expired (642ms)
  web3-candies resetNetworkFork to 29194866 +140ms
  web3-candies now block 29194866 +2s
  web3-candies deploying UniswapV2Exchange +11ms
...
CREATE MockExchange.constructor() => (0xA1041132B507466bE2b840b0BdFc78CA333b5861)
  web3-candies deployed MockExchange 0xA1041132B507466bE2b840b0BdFc78CA333b5861 deployer 0x040a92b0eb92c573a1594d032b139524bc6618f4 +238ms
  web3-candies impersonating 0x72A53cDBBcc1b9efa39c834A540550e23463AAcB +0ms
CALL WETH.transfer(to=[MockExchange], amount=10000000000000000000000)
   WETH.Transfer(from=[dstTokenWhale], to=[MockExchange], value=10000000000000000000000)
CALL MockExchange.setMockAmounts(_amounts=[0, 1000000000000000000])
  web3-candies deploying MockExchange +624ms
CREATE MockExchange.constructor() => (0xaCda8C6a10353046fC9a1a99AB4488B2f0e900ea)
  web3-candies deployed MockExchange 0xaCda8C6a10353046fC9a1a99AB4488B2f0e900ea deployer 0x040a92b0eb92c573a1594d032b139524bc6618f4 +244ms
CALL USDC.approve(spender=[TWAP], amount=2000000000)
   USDC.Approval(owner=[user], spender=[TWAP], value=2000000000)
CALL TWAP.ask(exchange=[MockExchange], srcToken=[USDC], dstToken=[WETH], srcAmount=2000000000, srcBidAmount=2000000000, dstMinAmount=1000000000000000000, deadline=1654431408, delay=60)
  ...
  web3-candies mining 1 block and advancing time by 10 seconds +473ms
...
CALL TWAP.ask(exchange=0x0000000000000000000000000000000000000000, srcToken=[USDC], dstToken=[WETH], srcAmount=2000000000, srcBidAmount=1000000000, dstMinAmount=500000000000000000, deadline=1654431404, delay=600)
   TWAP.OrderCreated(maker=[user], id=0, exchange=0x0000000000000000000000000000000000000000, ask=[1654430407, 1654431404, 600, [user], 0x0000000000000000000000000000000000000000, [USDC], [WETH], 2000000000, 1000000000, 500000000000000000])
  web3-candies mining 1 block and advancing time by 30 seconds +2s
...
CALL TWAP.bid(id=0, exchange=[UniswapV2Exchange], dstFee=10000000000000000, data=)
   TWAP.OrderBid(taker=[taker], id=0, exchange=[UniswapV2Exchange], bid=[1654431105, [taker], [UniswapV2Exchange], 549020611527226722, 10000000000000000, ])
      ✓ recently filled custom delay (4219ms)
  web3-candies resetNetworkFork to 29194866 +53ms
  web3-candies now block 29194866 +2s
  web3-candies deploying UniswapV2Exchange +12ms
...
CALL TWAP.bid(id=0, exchange=[UniswapV2Exchange], dstFee=100000000000000000, data=)
      ✓ insufficient amount out with excess fee (494ms)
  web3-candies resetNetworkFork to 29194866 +2s
  web3-candies now block 29194866 +2s
  web3-candies deploying UniswapV2Exchange +4ms
...
CALL TWAP.bid(id=0, exchange=[UniswapV2Exchange], dstFee=1000000000000000000, data=)
      ✓ fee underflow protection (508ms)
  web3-candies resetNetworkFork to 29194866 +2s
  web3-candies now block 29194866 +2s
...
CALL TWAP.ask(exchange=0x0000000000000000000000000000000000000000, srcToken=[USDC], dstToken=[WETH], srcAmount=2000000000, srcBidAmount=1500000000, dstMinAmount=750000000000000000, deadline=1654431404, delay=60)
  ...
  web3-candies deploying MockExchange +0ms
CREATE MockExchange.constructor() => ([MockExchange])
  web3-candies deployed MockExchange 0xA1041132B507466bE2b840b0BdFc78CA333b5861 deployer 0x040a92b0eb92c573a1594d032b139524bc6618f4 +240ms
  web3-candies impersonating 0x72A53cDBBcc1b9efa39c834A540550e23463AAcB +0ms
CALL WETH.transfer(to=[MockExchange], amount=10000000000000000000000)
   WETH.Transfer(from=[dstTokenWhale], to=[MockExchange], value=10000000000000000000000)
CALL MockExchange.setMockAmounts(_amounts=[0, 100000000000000000])
CALL TWAP.bid(id=0, exchange=[MockExchange], dstFee=10000000000000000, data=)
      ✓ insufficient amount out when last partial fill (5198ms)
  web3-candies resetNetworkFork to 29194866 +830ms
  web3-candies now block 29194866 +2s
  web3-candies deploying UniswapV2Exchange +6ms
  web3-candies deployed UniswapV2Exchange 0x74652f570B1A95235a9A054994319eeb827c5E17 deployer 0x040a92b0eb92c573a1594d032b139524bc6618f4 +460ms
  web3-candies deploying TWAP +2s
...
CALL USDC.approve(spender=[TWAP], amount=0)
   USDC.Approval(owner=[user], spender=[TWAP], value=0)
      ✓ insufficient user allowance (668ms)
  web3-candies resetNetworkFork to 29194866 +2s
  web3-candies now block 29194866 +2s
  web3-candies deploying UniswapV2Exchange +12ms
  web3-candies deployed UniswapV2Exchange 0x74652f570B1A95235a9A054994319eeb827c5E17 deployer 0x040a92b0eb92c573a1594d032b139524bc6618f4 +436ms
...
CALL USDC.transfer(to=[taker], amount=1000000000000)
   USDC.Transfer(from=[user], to=[taker], value=1000000000000)
      ✓ insufficient user balance (945ms)
    perform fill
  web3-candies resetNetworkFork to 29194866 +2s
  web3-candies now block 29194866 +2s
  web3-candies deploying UniswapV2Exchange +4ms
...
CALL TWAP.ask(exchange=0x0000000000000000000000000000000000000000, srcToken=[USDC], dstToken=[WETH], srcAmount=2000000000, srcBidAmount=1000000000, dstMinAmount=500000000000000000, deadline=1654431405, delay=60)
  ...
  web3-candies was: block 29194872 timestamp 2022-06-05T12:00:08.000Z now: block 29194873 timestamp 2022-06-05T14:46:48.000Z +1ms
      ✓ expired (528ms)
  ...
  web3-candies impersonating 0xF977814e90dA44bFA03b6295A0616a897441aceC +0ms
CALL TWAP.fill(id=0)
      ✓ invalid taker when no existing bid (490ms)
  web3-candies resetNetworkFork to 29194866 +2s
  web3-candies now block 29194866 +2s
  web3-candies deploying UniswapV2Exchange +3ms
  ...
  web3-candies impersonating 0xF977814e90dA44bFA03b6295A0616a897441aceC +1ms
CALL TWAP.fill(id=0)
      ✓ invalid taker when not the winning taker (543ms)
  web3-candies resetNetworkFork to 29194866 +2s
  web3-candies now block 29194866 +2s
  ...
  web3-candies impersonating 0xF977814e90dA44bFA03b6295A0616a897441aceC +1ms
CALL TWAP.fill(id=0)
      ✓ pending bid when still in bidding window (487ms)
  web3-candies resetNetworkFork to 29194866 +2s
  web3-candies now block 29194866 +2s
  web3-candies deploying UniswapV2Exchange +3ms
...
CALL TWAP.bid(id=0, exchange=[MockExchange], dstFee=10000000000000000, data=)
  ...
  web3-candies mining 1 block and advancing time by 10 seconds +680ms
  web3-candies was: block 29194875 timestamp 2022-06-05T12:00:10.000Z now: block 29194876 timestamp 2022-06-05T12:00:20.000Z +2ms
CALL MockExchange.setMockAmounts(_amounts=[0, 100000000000000000])
CALL TWAP.fill(id=0)
  ...
  web3-candies impersonating 0xF977814e90dA44bFA03b6295A0616a897441aceC +1ms
  web3-candies deploying MockExchange +2s
  web3-candies deployed MockExchange 0xA1041132B507466bE2b840b0BdFc78CA333b5861 deployer 0x040a92b0eb92c573a1594d032b139524bc6618f4 +224ms
...
CALL TWAP.bid(id=0, exchange=[MockExchange], dstFee=100000000000000000, data=)
  ...
  web3-candies was: block 29194875 timestamp 2022-06-05T12:00:11.000Z now: block 29194876 timestamp 2022-06-05T12:00:22.000Z +1ms
CALL MockExchange.setMockAmounts(_amounts=[0, 500000000000000000])
      ✓ insufficient out with excess fee (2449ms)
  web3-candies resetNetworkFork to 29194866 +1s
  web3-candies now block 29194866 +2s
  web3-candies deploying UniswapV2Exchange +3ms
...
CALL TWAP.bid(id=0, exchange=[MockExchange], dstFee=1000000000000000000, data=)
  ...
  web3-candies mining 1 block and advancing time by 10 seconds +713ms
  web3-candies was: block 29194875 timestamp 2022-06-05T12:00:11.000Z now: block 29194876 timestamp 2022-06-05T12:00:21.000Z +2ms
      ✓ fee subtracted from dstAmountOut underflow protection (2466ms)
  web3-candies resetNetworkFork to 29194866 +1s
  web3-candies now block 29194866 +2s
  web3-candies deploying UniswapV2Exchange +4ms
  web3-candies deployed UniswapV2Exchange 0x74652f570B1A95235a9A054994319eeb827c5E17 deployer 0x040a92b0eb92c573a1594d032b139524bc6618f4 +440ms
...
CALL TWAP.ask(exchange=0x0000000000000000000000000000000000000000, srcToken=[USDC], dstToken=[WETH], srcAmount=3000000, srcBidAmount=2000000, dstMinAmount=1000000000000000000, deadline=1654430505, delay=60)
   TWAP.OrderCreated(maker=[user], id=0, exchange=0x0000000000000000000000000000000000000000, ask=[1654430407, 1654430505, 60, [user], 0x0000000000000000000000000000000000000000, [USDC], [WETH], 3000000, 2000000, 1000000000000000000])
    ✓ maker creates ask order, emits event (545ms)
  web3-candies resetNetworkFork to 29194866 +2s
  web3-candies now block 29194866 +1s
  web3-candies deploying UniswapV2Exchange +3ms
  ...
  web3-candies deployed TWAP 0xCE5c12eEA2772EFc7A665E7aA26c059D6fDC5de5 deployer 0x040a92b0eb92c573a1594d032b139524bc6618f4 +245ms
  web3-candies impersonating 0xF977814e90dA44bFA03b6295A0616a897441aceC +1ms
    ✓ bid sets Bid fields, emits event (490ms)
  web3-candies resetNetworkFork to 29194866 +2s
  web3-candies now block 29194866 +2s
  web3-candies deploying UniswapV2Exchange +4ms
  web3-candies deployed UniswapV2Exchange 0x74652f570B1A95235a9A054994319eeb827c5E17 deployer 0x040a92b0eb92c573a1594d032b139524bc6618f4 +433ms
  ...
  web3-candies was: block 29194872 timestamp 2022-06-05T12:00:07.000Z now: block 29194873 timestamp 2022-06-05T12:00:37.000Z +1ms
    ✓ fill sets Fill fields and clears the Bid, emits event (5253ms)
...
CALL TWAP.cancel(id=0)
   TWAP.OrderCanceled(sender=[user], id=0)
    ✓ cancel order, emits event (506ms)
  web3-candies resetNetworkFork to 29194866 +2s
  web3-candies now block 29194866 +2s
  web3-candies deploying UniswapV2Exchange +5ms
...
CALL TWAP.fill(id=0)
   ...
   TWAP.OrderCompleted(taker=[taker], id=0)
    ✓ order fully filled, emits event (4496ms)
    History
  web3-candies resetNetworkFork to 29194866 +196ms
  web3-candies now block 29194866 +2s
  web3-candies deploying UniswapV2Exchange +3ms
...
CALL TWAP.ask(exchange=0x0000000000000000000000000000000000000000, srcToken=[USDC], dstToken=[WETH], srcAmount=1000000000, srcBidAmount=1000000000, dstMinAmount=500000000000000000, deadline=1654430422, delay=60)
  ...
  web3-candies mining 1 block and advancing time by 10 seconds +827ms
  web3-candies was: block 29194879 timestamp 2022-06-05T12:00:14.000Z now: block 29194880 timestamp 2022-06-05T12:00:24.000Z +1ms
      ✓ find orders for maker (236ms)

  TWAP
  web3-candies resetNetworkFork to 29194866 +237ms
  web3-candies now block 29194866 +2s
  web3-candies deploying UniswapV2Exchange +5ms
  web3-candies deployed UniswapV2Exchange 0x74652f570B1A95235a9A054994319eeb827c5E17 deployer 0x040a92b0eb92c573a1594d032b139524bc6618f4 +440ms
  web3-candies deploying TWAP +2s
...
CALL TWAP.ask(exchange=0x0000000000000000000000000000000000000000, srcToken=[USDC], dstToken=[WETH], srcAmount=10000000000, srcBidAmount=2500000000, dstMinAmount=1250000000000000000, deadline=1654431404, delay=60)
  ...
  web3-candies mining 1 block and advancing time by 60 seconds +127ms
...
CALL TWAP.ask(exchange=0x0000000000000000000000000000000000000000, srcToken=[USDC], dstToken=[WETH], srcAmount=10000000000, srcBidAmount=4000000000, dstMinAmount=2000000000000000000, deadline=1654431405, delay=60)
   TWAP.OrderCreated(maker=[user], id=0, exchange=0x0000000000000000000000000000000000000000, ask=[1654430407, 1654431405, 60, [user], 0x0000000000000000000000000000000000000000, [USDC], [WETH], 10000000000, 4000000000, 2000000000000000000])
  web3-candies mining 1 block and advancing time by 10 seconds +2s
  ...
  web3-candies mining 1 block and advancing time by 60 seconds +4s
  web3-candies was: block 29194874 timestamp 2022-06-05T12:00:19.000Z now: block 29194875 timestamp 2022-06-05T12:01:22.000Z +3ms
  ...
  web3-candies was: block 29194878 timestamp 2022-06-05T12:01:34.000Z now: block 29194879 timestamp 2022-06-05T12:02:35.000Z +1ms
  web3-candies mining 1 block and advancing time by 10 seconds +53ms
  web3-candies was: block 29194880 timestamp 2022-06-05T12:02:36.000Z now: block 29194881 timestamp 2022-06-05T12:02:46.000Z +3ms
    ✓ last chunk may be partial amount (4396ms)
  web3-candies resetNetworkFork to 29194866 +173ms
  web3-candies now block 29194866 +2s
  web3-candies deploying UniswapV2Exchange +4ms
...
CALL TWAP.bid(id=0, exchange=[MockExchange], dstFee=10000000000000000, data=)
  ...
  web3-candies mining 1 block and advancing time by 10 seconds +701ms
...
CALL TWAP.fill(id=0)
   ...
   TWAP.OrderFilled(taker=[taker], id=0, exchange=[MockExchange], srcToken=[USDC], dstToken=[WETH], srcAmountIn=1000000000, dstAmountOut=590000000000000000, dstFee=10000000000000000, filledTime=1654430423, srcFilledAmount=1000000000)
    ✓ outbid current bid within pending period (2998ms)
  web3-candies resetNetworkFork to 29194866 +2s
  web3-candies now block 29194866 +2s
  web3-candies deploying UniswapV2Exchange +2ms
  web3-candies deployed UniswapV2Exchange 0x74652f570B1A95235a9A054994319eeb827c5E17 deployer 0x040a92b0eb92c573a1594d032b139524bc6618f4 +443ms
...
CALL TWAP.bid(id=0, exchange=[UniswapV2Exchange], dstFee=1000000000000000, data=)
   TWAP.OrderBid(taker=0x56C037B948a812C5A0Ad9cCc122F5015EF928F27, id=0, exchange=[UniswapV2Exchange], bid=[1654430409, 0x56C037B948a812C5A0Ad9cCc122F5015EF928F27, [UniswapV2Exchange], 558082872850656255, 1000000000000000, ])
    ✓ outbid current bid within pending period same path and amount but lower fee (578ms)
  web3-candies resetNetworkFork to 29194866 +102ms
  web3-candies now block 29194866 +2s
  web3-candies deploying UniswapV2Exchange +4ms
...
CALL TWAP.bid(id=0, exchange=[UniswapV2Exchange], dstFee=10000000000000000, data=)
  ...
  web3-candies was: block 29194874 timestamp 2022-06-05T12:01:06.000Z now: block 29194875 timestamp 2022-06-05T12:01:07.000Z +1ms
    ✓ clears stale unfilled bid after max bidding window (542ms)
  web3-candies resetNetworkFork to 29194866 +37ms
  web3-candies now block 29194866 +2s
  web3-candies deploying UniswapV2Exchange +3ms
  web3-candies deployed UniswapV2Exchange 0x74652f570B1A95235a9A054994319eeb827c5E17 deployer 0x040a92b0eb92c573a1594d032b139524bc6618f4 +440ms
...
CALL TWAP.fill(id=0)
   ...
   TWAP.OrderFilled(taker=[taker], id=0, exchange=[UniswapV2Exchange], srcToken=[USDC], dstToken=[WETH], srcAmountIn=1000000000, dstAmountOut=549082872850656255, dstFee=10000000000000000, filledTime=1654430421, srcFilledAmount=1000000000)
    ✓ supports market orders, english auction incentivizes best competitive price (4312ms)
    prune stale invalid order
...
CALL TWAP.prune(id=0)
   TWAP.OrderCanceled(sender=[deployer], id=0)
      ✓ when no balance (946ms)

·-----------------------------------|---------------------------|-------------|-----------------------------·
|       Solc version: 0.8.10        ·  Optimizer enabled: true  ·  Runs: 200  ·  Block limit: 10000000 gas  │
····································|···························|·············|······························
|  Methods                          ·               51 gwei/gas               ·       0.82 usd/matic        │
·················|··················|·············|·············|·············|···············|··············
|  Contract      ·  Method          ·  Min        ·  Max        ·  Avg        ·  # calls      ·  usd (avg)  │
·················|··················|·············|·············|·············|···············|··············
...
····································|·············|·············|·············|···············|··············
|  TWAP                             ·          -  ·          -  ·    2490580  ·       24.9 %  ·       0.10  │
····································|·············|·············|·············|···············|··············
|  UniswapV2Exchange                ·          -  ·          -  ·     646460  ·        6.5 %  ·       0.03  │
·-----------------------------------|-------------|-------------|-------------|---------------|-------------·
